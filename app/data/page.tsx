        ...
        <div className="glass-nav p-6 border-b border-white/10">
          <div className="text-center space-y-4">
            <h1 className="text-2xl md:text-4xl font-bold">
              <span className="neon-text">NASA Data</span>{" "}
              <span className="glass-text-primary">Hub</span>
            </h1>
            <p className="glass-text-secondary text-sm md:text-base max-w-3xl mx-auto leading-relaxed">
              Access real-time satellite data from multiple NASA missions for accurate agricultural decision-making
            </p>
          </div>
        </div>

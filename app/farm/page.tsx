...
const SimpleWorking3D = dynamic(() => import("@/components/simple-working-3d"), {
  ssr: false,
  loading: () => (
    <div className="flex items-center justify-center h-full min-h-[300px] glass-container">
      <div className="text-center space-y-2">
        <div className="w-8 h-8 border-2 border-cyan-500 border-t-transparent rounded-full animate-spin mx-auto"></div>
        <p className="glass-text-secondary text-sm">Loading 3D Farm View...</p>
      </div>
    </div>
  )
})
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {farmFeatures.map((feature) => {
            ...
            return (
              <Card key={feature.id} className={`bg-black/80 backdrop-blur-xl border ${feature.color.split(' ')[2]} hover:scale-105 transition-transform duration-200`}>
                <CardHeader>
